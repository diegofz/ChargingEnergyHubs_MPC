...
class MPCstochv2week:
    """
    MPCstochv2: SOCP and scenario-based formualtion
    """
    ...
    def _formulate(self, env):
        ...
        constraints += [ self.p_i_n == cp.reshape(self.p_i_n[:, 0], (env.horizon_optimization, 1)) ] # battery takes the same action across all scenarios
